...
ActiveRecord::Base.transaction do
  100.times.map do |t|
    Drug.create name: Faker::Commerce.product_name, dispense_amount: '20mcg', dispense_frequency: 'bid', 
      uuid: SecureRandom.uuid, adult_dosing: '2 pills bid', peds_dosing: '1 pill bid', contraindications: 'Sulfa', 
      pharmacy_instructions: Faker::Lorem.sentence, patient_instructions: Faker::Lorem.sentence
    wrlog '.'
  end
end
